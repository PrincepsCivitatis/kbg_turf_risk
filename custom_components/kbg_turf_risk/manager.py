...
Listens to a temperature and humidity entity already in Home Assistant
(e.g. your Ecowitt integration's outdoor temp/humidity sensors), accumulates
...
All math is done in Celsius internally to match the published models;
the configured GDD base temperature may be entered in Fahrenheit for
convenience and is converted on load.
"""
